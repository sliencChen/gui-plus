...
//        m_LocalDeclarations.insert(Declaration);
    	m_LocalDeclarations.Add(Declaration);
    }
//    else
//    {
...
void wxsCoderContext::AddStructure(const wxString& Structure)
{
	m_WindowStructures.Add(Structure);
}
